...
class MyView(nextcord.ui.View):
    ...
    async def __init__(self, message: nextcord.Message= None, *, timeout: int = 180.0, items: List[nextcord.ui.Item]):
    ...
    async def stop_all_items(self):
        ...
        newView = self.__class__(self.message) # Create a new view that has the same message
