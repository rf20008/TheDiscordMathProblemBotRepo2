...
class MathProblemCache:
    ...
    async def get_problem(self, guild_id: typing.Optional[int], problem_id: int) -> BaseProblem:
    ...
    async def get_problems_by_guild_id(self, guild_id: int) -> typing.Dict[int, BaseProblem]:
        if not isinstance(guild_id, int) and guild_id is not None:
    ...
    async def remove_problem(self, guild_id: typing.Optional[int], problem_id: int) -> BaseProblem:
