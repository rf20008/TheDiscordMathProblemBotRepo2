...
async def on_slash_command_error(ctx, error):
    ...
    await ctx.reply(embed=ErrorEmbed("''"+(traceback.format_exception(etype=type(error),value=str(error),tb=error.__traceback__)) + "''",custom_title="Oh, no! An exception occurred"))
